	...
	<div class="main-container">
		<div class="container-fluid">
			<section>
				...
				<?php echo form_open("superadmin/unit_kerja/simpan"); ?>
				
				<label for="unit_kerja">Nama Unit Kerja</label>
				<div class="cleaner_h5"></div>
				<input type="search" style="width:90%;" id="unit_kerja" name="unit_kerja" placeholder="Nama Unit Kerja" value="<?php echo $unit_kerja; ?>" />
