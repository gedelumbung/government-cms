...
class password extends MX_Controller {
	...
	public function index()
	{
		if($this->session->userdata("logged_in")!="" && $this->session->userdata("tipe_user")=="pengawas")
		{
			...
			$this->load->view($_SESSION['site_theme'].'/pengawas/password/bg_home');
	...
	public function simpan()
	{
		if($this->session->userdata("logged_in")!="" && $this->session->userdata("tipe_user")=="pengawas")
		{
			...
			else
			{
				...
				$cek['username_user_pengawas'] 	= $id['username_user_pengawas'];
