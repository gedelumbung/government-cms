...
class pengawas_sekolah extends MX_Controller {
   ...
   {  
      ...
      $d['dt_index_data_kepegawaian'] = $this->app_global_model->generate_index_data_pengawas_sekolah($this->config->item("limit_item"),$uri);
      ...
      $this->load->view($_SESSION['site_theme'].'/pengawas_sekolah/bg_home');
